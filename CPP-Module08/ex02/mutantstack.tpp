...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/07 22:01:42 by tandroma          #+#    #+#             */
/*   Updated: 2022/11/07 22:15:30 by tandroma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <typename T>
MutantStack<T>::Iterator::Iterator(const T *ptr): ptr(const_cast<T*>(ptr))
{
}
...
template <typename T>
bool	MutantStack<T>::Iterator::operator==(const MutantStack<T>::Iterator &it)
{
...
{
	out << "Size stack " << mutantStack.size() << std::endl;
	int		i = 0;
